...
@section('content')
    ...
    <form id="myForm" action="{{ route('produk-kategori.update', $kategori->id) }}" method="post"
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href =
                                    '{{ route('produk-kategori.index') }}'; // Ganti URL dengan halaman yang ingin Anda arahkan
                            } else {
