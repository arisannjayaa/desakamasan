                ...
                <div class="card-body">
                    <form action="{{ route('profil.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-lg-row flex-column align-items-lg-end align-items-start gap-4">
                            <img id="preview-foto" class="d-block" height="100" width="100" src=""
                                alt="">
                            <div class="d-flex flex-column align-items-stretch gap-3">
                                <button id="btn_triger_input_foto" type="button"
                                    class="btn btn-primary align-self-start">Unggah foto baru</button>
                                <input id="input_foto" type="file" name="foto" value="" hidden>
