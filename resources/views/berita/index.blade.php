        ...
        <div class="w-full mb-1">
            <div class="mb-4 flex justify-between align-items-center">
                ...
                <button type="button"
                    ...
                    onclick="window.location.href='{{ $links['create'] }}'">Tambah</button>
            </div>
        </div>
    </div>
    <div class="border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
